        ...
        <div className="card bg-base-200 border border-base-300">
          <div className="card-body divide-y divide-base-300 p-0 overflow-x-auto">
            <div className="min-w-[500px]">
              ...
              <div className="grid grid-cols-[150px_100px_1fr] gap-4 p-4 text-sm items-start">
                <Code>ig_session_id</Code>
                <Badge color="warning">required</Badge>
                <span className="text-base-content/70">
                  Instagram <Code>sessionid</Code> cookie value
                </span>
              </div>
              <div className="grid grid-cols-[150px_100px_1fr] gap-4 p-4 text-sm items-start">
                <Code>limit</Code>
                ...
                <span className="text-base-content/70">
                  Max posts to return (Recommended max: 50)
                </span>
              </div>
            </div>
          </div>
...

{
  ...
  "limit": 20
      ...
      <section className="space-y-4">
        ...
        <Block>{`const res = await fetch('/instagram', {
  method: 'POST',
      ...
      <section className="space-y-4">
        ...
        <div className="card bg-base-200 border border-base-300">
          <div className="card-body p-0">
            {[
              ["400", "Missing u or session ID / invalid username"],
              ["401", "Missing ig_session_id in body"],
